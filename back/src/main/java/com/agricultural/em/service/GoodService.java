...
import com.agricultural.em.constants.RedisConstants;
import com.agricultural.em.entity.Good;
import com.agricultural.em.entity.GoodStandard;
import com.agricultural.em.entity.dto.GoodDTO;
...
import com.agricultural.em.mapper.GoodMapper;
...
public class GoodService extends ServiceImpl<GoodMapper, Good> {
    ...
    //保存商品信息
    public Integer saveOrUpdateGood(Good good) {
    ...
    public IPage<Good> findFullPage(Integer pageNum, Integer pageSize, String searchText, Integer categoryId) {
        ...
        for (Good good : page.getRecords()) {
            //附上最低价格
            good.setPrice(getMinPrice(Long.valueOf(good.getId())));
        }
        return page;
    }
}
