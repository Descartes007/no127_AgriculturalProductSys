  ...
  <div>
    ...
    <div style="padding-top: 10px">
      <el-button type="primary" @click="handleAdd" style="font-size: 18px;"
        >
        <i class="iconfont icon-r-add" style="padding-right: 6px;font-size: 22px;"></i
        >
        新增</el-button
      >
      <el-button type="danger" @click="delBatch" style="font-size: 18px;"
        ><i class="iconfont icon-r-delete" style="padding-right: 6px; font-size: 22px;"></i
        > 批量删除</el-button
      >
    </div>
    <!--          弹窗-->
    ...
    >
      ...
      <el-table-column label="身份" width="150">
        <template slot-scope="scope">
          ...
          <span v-if="scope.row.role === 'farmer'">农户</span>
