...
const routes = [
    //前台
  {
    ...
    meta: {title:'农产品销售平台', path: '农产品销售平台', requireAuth: false},
    children: [
      {path: 'person', name: 'person', meta: {title:'个人信息',requireLogin: true}, component: () => import('../views/Person.vue'),},
      {path: 'topview', name: 'topview', meta: {title:'农产品销售平台'}, component: () => import('../views/front/TopView.vue'),},
      {path: 'cart', name: 'cart', meta: {title:'我的购物车',requireLogin: true}, component: () => import('../views/front/good/Cart.vue'),},
      {path: 'goodList', name: 'goodList', meta: {title:'产品界面'}, component: () => import('../views/front/good/GoodList.vue'),},
      {path: 'goodView/:goodId', name: 'goodview', meta: {title:'产品详情'}, component: () => import('../views/front/good/GoodView.vue'),},
    ...
    //后台
  {
    ...
    children: [
      ...
      {path: 'carousel', name: 'carousel', meta: {title:'轮播图管理',path: '产品/轮播图管理',requireAuth: true}, component: () => import('../views/manage/good/Carousel.vue'),},
      {path: 'category', name: 'category', meta: {title:'产品分类管理',path: '产品/产品分类管理',requireAuth: true}, component: () => import('../views/manage/good/Category.vue'),},
      {path: 'good', name: 'good', meta: {title:'产品管理',path: '产品/产品管理',requireAuth: true}, component: () => import('../views/manage/good/Goods.vue'),},
      {path: 'goodInfo', name: 'goodInfo', meta: {title:'产品管理',path: '产品/产品管理/产品信息',requireAuth: true}, component: () => import('../views/manage/good/GoodInfo.vue'),},
      {path: 'order', name: 'order', meta: {title:'订单管理',path: '产品/订单管理',requireAuth: true}, component: () => import('../views/manage/Order.vue'),},
      ...
      {path: 'checkList', name: 'checkList', meta: {title:'产品审核',path: '审核/审核列表',requireAuth: true}, component: () => import('../views/manage/check/CheckList.vue'),},
      {path: 'checkInfo', name: 'checkInfo', meta: {title:'产品审核',path: '/审核/审核列表/新增审核',requireAuth: true}, component: () => import('../views/manage/check/CheckInfo.vue'),},
      {path: 'checkDetails', name: 'checkDetails', meta: {title:'产品审核',path: '/审核/审核列表/产品详情',requireAuth: true}, component: () => import('../views/manage/check/CheckDetails.vue'),},
    ]
  },
  {
    path: '/login',
